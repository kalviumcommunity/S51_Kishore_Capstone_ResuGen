  ...
  return (
    <>
      <div className="res-temp1">
        <h1>
          {capitalizeFirstLetter(formData.firstName || "John")}{" "}
          {capitalizeFirstLetter(formData.lastName || "Doe")}
        </h1>
        <p className="job-title">{capitalizeFirstLetter(formData.jobTitle || "Software Engineer")}</p>
          ...
          <div className="res1-top-left">
            <div className="user-contacts">
              ...
              <div className="contacts">
                ...
                <p>
                  <IoMdHome />{" "}
                  {capitalizeFirstLetter(formData.city || "New York")}{" "}
                  {capitalizeFirstLetter(formData.state || "New York")}{" "}
                  {capitalizeFirstLetter(formData.country || "USA")}{" "}
                  {formData.zipCode || "10001"}
                </p>
              </div>
            </div>
            ...
            <div className="education-info-div">
              ...
              {educationFormData.map((eduData, index) => (
                <div className="res1-education" key={index}>
                  ...
                  <p>
                    {capitalizeFirstLetter(eduData.SchoolLocation || "Paris")}
                  </p>
                  <p>
                    {eduData.StartDate || ""} - {eduData.LastDate || "Present"}
                  </p>
            ...
            <div className="res1-experience-info-div">
              ...
              {experienceDataList.map((expData, index) => (
                <div className="res1-exp" key={index}>
                  ...
                  <p>
                    {expData.StartDate} - {expData.LastDate}
                  </p>

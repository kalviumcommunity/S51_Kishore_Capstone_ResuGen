...
const ResTemp2 = () => {
  ...
  return (
    <div className="restemp2-resume">
      ...
      <section className="restemp2-contacts">
        <h2>Contacts</h2>
      ...
      <section className="restemp2-skills">
      ...
      <section className="restemp2-summary">
        <h2>Summary</h2>
        <p>{formData.profileDescription}</p>
      </section>
      <section className="restemp2-education">
        <h2>Education</h2>
      ...
      <section className="restemp2-experience">
        <h2>Experience</h2>
